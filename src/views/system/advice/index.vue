<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户ID地址" prop="ip">
        <el-input
          v-model="queryParams.ip"
          placeholder="请输入用户ID地址"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:advice:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['system:advice:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="adviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="建议人" align="center" prop="name" />
      <el-table-column label="电子邮件" align="center" prop="email" />
      <el-table-column label="手机号码" align="center" prop="phone" />
      <el-table-column label="意见" align="center" prop="message" />
      <el-table-column label="时间" align="center" prop="time" width="180">
        <template #default="scope">
          <span>{{ parseTime(scope.row.time, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="用户ID地址" align="center" prop="ip" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:advice:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="adviceRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="建议人" prop="name">
          <el-input v-model="form.name" placeholder="请输入建议人" />
        </el-form-item>
        <el-form-item label="电子邮件" prop="email">
        ...
        <el-form-item label="用户ID地址" prop="ip">
          <el-input v-model="form.ip" placeholder="请输入用户ID地址" />
        </el-form-item>
      </el-form>
      <template #footer>
...
function getList() {
  ...
  listAdvice(queryParams.value).then(response => {
    adviceList.value = response.rows;
...
function handleExport() {
  proxy.download('system/advice/export', {
    ...queryParams.value
