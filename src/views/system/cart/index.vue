<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="商品ID" prop="courseId">
        <el-input
    ...
    <el-table v-loading="loading" :data="cartList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品ID" align="center" prop="courseId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:cart:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:cart:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="cartRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品ID" prop="courseId">
          <el-input v-model="form.courseId" placeholder="请输入商品ID" />
        </el-form-item>
        <el-form-item label="商品名称" prop="title">
...
function handleExport() {
  proxy.download('system/cart/export', {
    ...queryParams.value
